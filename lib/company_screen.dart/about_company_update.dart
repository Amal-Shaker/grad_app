...
class AboutCompanyUpdate extends StatefulWidget {
  const AboutCompanyUpdate({Key? key}) : super(key: key);

  @override
  State<AboutCompanyUpdate> createState() => _AboutCompanyState();
}

class _AboutCompanyState extends State<AboutCompanyUpdate> {
  @override
  void initState() {
    super.initState();
            ...
            child: Column(
              children: [
                ...
                InkWell(
                  ...
                  onTap: () async {
                    await provider.updateCompanyInfo(
                        context, provider.companyInfoById!.company_id);
                  },
                )
              ],
            ),
