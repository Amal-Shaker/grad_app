...
class ChatRoomCompany extends StatefulWidget {
  // static final routeName = 'chatpage';
  String toId;
  String fromId;
  ChatRoomCompany(this.toId, this.fromId);
  @override
  State<ChatRoomCompany> createState() => _ChatRoomState();
}

class _ChatRoomState extends State<ChatRoomCompany> {
  String? twoId;
  ...
  method() {
    ...
    int fromId = int.parse(widget.fromId);
